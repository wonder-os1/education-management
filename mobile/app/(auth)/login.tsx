    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1, backgroundColor: '#f8fafc' }}>
      <View style={{ flex: 1, justifyContent: 'center', paddingHorizontal: 24 }}>
        <View style={{ alignItems: 'center', marginBottom: 48 }}>
          ...
          <Text style={{ fontSize: 24, fontWeight: 'bold', color: '#0f172a' }}>EduConnect Academy</Text>
        ...
        <View style={{ gap: 16 }}>
          <View>
            ...
            <TextInput value={email} onChangeText={setEmail} placeholder="teacher@school.edu" keyboardType="email-address" autoCapitalize="none"
          ...
          <TouchableOpacity onPress={() => router.push('/(auth)/signup')} style={{ alignItems: 'center', marginTop: 8 }}>
            <Text style={{ color: '#0284C7', fontSize: 14 }}>Don't have an account? Sign Up</Text>
          </TouchableOpacity>
        </View>
      </View>
